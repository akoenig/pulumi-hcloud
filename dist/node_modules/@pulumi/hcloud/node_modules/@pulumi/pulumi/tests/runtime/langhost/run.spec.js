                ...
                (call, callback) => {
                    ...
                    if (req.getType() !== index_1.runtime.rootPulumiStackTypeName || opts.showRootResourceRegistration) {
                        if (opts.registerResource) {
                            ...
                            const version = req.getVersion();
                            const { urn, id, props } = opts.registerResource(ctx, dryrun, t, name, res, deps, custom, protect, parent, provider, propertyDeps, ignoreChanges, version);
                            resp.setUrn(urn);
                            resp.setId(id);
...
function createMockEngine(opts, invokeCallback, readResourceCallback, registerResourceCallback, registerResourceOutputsCallback, logCallback, getRootResourceCallback, setRootResourceCallback) {
