...
export declare const isNodeAtLeastV11: boolean;
/**
 ...
 */
export declare function getSessionAsync(): Promise<import("inspector").Session>;
/**
 ...
 */
export declare function isInitializedAsync(): Promise<void>;
/**
 * Maps from a script-id to the local file url it corresponds to.
 */
export declare function getScriptUrl(id: import("inspector").Runtime.ScriptId): string | undefined;
